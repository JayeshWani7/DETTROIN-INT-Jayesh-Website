...
export const BoardingPage: React.FC<BoardingPageProps> = ({ onOpenApplyModal }) => {
  return (
    <div className="w-full">
      <PageHeader
        badge="LIFE AT PAVNA • RESIDENTIAL BOARDING"
        title="A Safe, Supportive Home Away From Home."
        subtitle="Our residential boarding offers modern air-conditioned suites, attached bathrooms, 24/7 pastoral care, nutritionist-planned dining, and structured evening study circles."
